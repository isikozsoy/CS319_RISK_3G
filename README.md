...
We also plan on having the players be able to attack non-neighboring territories by building an airport on their territories. It will cost 5 soldiers (can be changed). By using a plane, a player will be able to attack a territory which is up to 3 (may be changed as well) territories away.
